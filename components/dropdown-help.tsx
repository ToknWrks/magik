        ...
        <>
          ...
          >
            ...
            <MenuItems as="ul" className="focus:outline-none">
              ...
              <MenuItem as="li">
                {({ active }) => (
                  <Link className={`font-medium text-sm flex items-center py-1 px-3 ${active ? 'text-gray-600 dark:text-yellow-700' : 'text-yellow-700'}`} href="/cart">
                    <svg className="w-3 h-3 fill-current text-gray-500 shrink-0 mr-2" viewBox="0 0 12 12">
              ...
              <MenuItem as="li">
                {({ active }) => (
                  <Link className={`font-medium text-sm flex items-center py-1 px-3 ${active ? 'text-gray-600 dark:text-yellow-700' : 'text-yellow-700'}`} href="/checkout">
                    <svg className="w-3 h-3 fill-current text-gray-500 shrink-0 mr-2" viewBox="0 0 12 12">
              ...
              <MenuItem as="li">
                {({ active }) => (
                  <a
                    className={`font-medium text-sm flex items-center py-1 px-3 ${active ? 'text-gray-600 dark:text-yellow-700' : 'text-yellow-700'}`}
                    href="https://x.com/illuminatico"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg className="w-3 h-3 fill-current text-gray-500 shrink-0 mr-2" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                    <span>@illuminatico</span>
                  </a>
                )}
              </MenuItem>
            </MenuItems>
