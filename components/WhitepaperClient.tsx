...
const NAV_ITEMS = [
  ...
  { id: "illum", label: "5. Illuminati Magik (SIGIL) Token" },
      ...
      >
        ...
        <div className="relative mb-[50vh] flex gap-12 py-[40px] md:py-[80px]">
          ...
          <div className="flex flex-1 flex-col gap-[50px] md:gap-[70px] min-w-0">
            ...
            {/* ── 5. SIGIL Token ── */}
            <SectionBlock id="illum" title="5. Illuminati Magik (SIGIL) Token" index={4} setActiveIndex={setActiveIndex}>
              <Para>
                Illuminati Magik (SIGIL) is the platform&rsquo;s governance and value accrual token.
                <strong className="text-zinc-300"> Fixed supply of 100,000,000 SIGIL</strong> — no
                inflation after genesis. SIGIL holders govern the platform and earn a
              ...
              <Para>
                Staking SIGIL earns a pro-rata share of protocol fee revenue and governance
              ...
              <Kicker>Token distribution (100,000,000 SIGIL total)</Kicker>
              <DataTable rows={[
                ["40% — Community airdrop (40M)", "Early members and community — front-loaded in Year 1 to bootstrap staking depth"],
                ["25% — Liquidity (25M)", "Protocol-owned SIGIL/USDC pool on Base · seeded at launch"],
            ...
            <SectionBlock id="roadmap" title="6. Roadmap" index={5} setActiveIndex={setActiveIndex}>
              ...
              <Bullets items={[
                ...
                "SIGIL token launch — governance, staking, fee-share contracts on Base",
                "Mobile app builds",
            ...
            <SectionBlock id="risks" title="7. Risk Factors" index={6} setActiveIndex={setActiveIndex}>
              ...
              <Bullets items={[
                "Regulatory risk: digital token classification varies by jurisdiction. SIGIL is a utility token with no guarantee of regulatory clarity in all markets.",
                ...
                "Liquidity risk: SIGIL is a new token. Secondary market liquidity may be insufficient for large positions. Do not allocate more than you can afford to lose.",
