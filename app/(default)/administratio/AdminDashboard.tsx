      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div className="mb-4 sm:mb-0">
          <ul className="flex flex-wrap -m-1">
            ...
            <li className="m-1">
              <Link href="/administratio/invites" className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition">
                Invites
              </Link>
            </li>
            <li className="m-1">
            ...
            <li className="m-1">
              <Link href="/administratio/regen" className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-green-200 dark:border-green-700/60 hover:border-green-300 dark:hover:border-green-600 shadow-sm bg-white dark:bg-gray-800 text-green-600 dark:text-green-400 transition">
                Regen
              </Link>
            </li>
            <li className="m-1">
              <Link href="/administratio/roadmap" className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-violet-200 dark:border-violet-700/60 hover:border-violet-300 dark:hover:border-violet-600 shadow-sm bg-white dark:bg-gray-800 text-violet-600 dark:text-violet-400 transition">
                Roadmap
              </Link>
            </li>
            <li className="m-1">
              <Link href="/administratio/leads" className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-sky-200 dark:border-sky-700/60 hover:border-sky-300 dark:hover:border-sky-600 shadow-sm bg-white dark:bg-gray-800 text-sky-600 dark:text-sky-400 transition">
                X Leads
              </Link>
            </li>
            <li className="m-1">
