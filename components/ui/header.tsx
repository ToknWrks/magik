...
export default function Header({
  ...
  const [meditationModalOpen, setMeditationModalOpen] = useState<boolean>(false)
  ...
  return (
    <>
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className={`flex items-center justify-between h-16 ${variant === 'v2' || variant === 'v3' ? '' : ''}`}>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <button
                  className={`w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full ml-3 ${meditationModalOpen && 'bg-gray-200 dark:bg-gray-800'}`}
                  onClick={() => { setMeditationModalOpen(true) }}
                >
                  <span className="sr-only">Meditation</span>
                  <svg className="fill-current text-gray-500/80 dark:text-gray-400/80" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Meditation Modal */}
      <Transition appear show={meditationModalOpen}>
        <Dialog as="div" onClose={() => setMeditationModalOpen(false)}>
          <Transition.Child
            as="div"
          ...
          >
            <Dialog.Panel className="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg p-8 mt-20 text-center">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-600 mt-8">
                ...
                <a 
                  href="https://ggia.berkeley.edu/practice/mindful_breathing#data-tab-how" 
                  target="_blank" 
